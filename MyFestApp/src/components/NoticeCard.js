...
const cardBg = require('../../assets/svg/card_bg_expanded.png');
const tornFrame = require('../../assets/svg/torn_frame.png');
...
export default function NoticeCard({ event, isExpanded, onToggleExpand, isDismissed }) {
  return (
    <TouchableOpacity
      activeOpacity={0.9}
    ...
    >
      ...
      >
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.department}>by {event["Author"]}</Text>
